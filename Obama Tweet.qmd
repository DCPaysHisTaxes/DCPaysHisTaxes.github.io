...
I have done some additional work and removed some of the most commonly used words in English. This includes articles, preposistions, etc.
I used the str_lower (to remove case-sensitive words), str_replace_all (to get rid of punction for easier wrangling)), and str_length(to compute and scan strings) to conuduct my operations. 
